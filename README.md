...
- **[🔧 Troubleshooting: App Fecha ao Abrir](./TROUBLESHOOTING_APP_CRASH.md)** - Solução para app que fecha imediatamente
- **[🔧 Troubleshooting: Build Errors](./TROUBLESHOOTING_BUILD.md)** - Erros comuns de build
